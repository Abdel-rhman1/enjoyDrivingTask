                ...
                <div id="custom_styles" class="col-lg-12 layout-spacing col-md-12">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area p-3">
                            <form class="row g-3 needs-validation" novalidate action="{{route('menus.store')}}" method="post">
                                @csrf
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="price" class="form-control" id="validationCustom02" value="Otto"
                                        required>
